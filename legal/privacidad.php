...
<main class="wrap">
    <h1 class="text-center m-4">Politicas de Privacidad</h1>
    <p class="mr-5 ml-5">Política de privacidad de Divisione

    Esta Política de privacidad describe cómo se recopila, utiliza y comparte su información personal cuando visita o hace una compra en https://divisione.es (denominado en lo sucesivo el “Sitio”).
    ...
    CONTÁCTENOS
    Para obtener más información sobre nuestras prácticas de privacidad, si tiene alguna pregunta o si desea presentar una queja, contáctenos por correo electrónico a xxkaise@gmail.com o por correo mediante el uso de la información que se proporciona a continuación:

    General Dávila, 1, Santander, CB, 39007, España</p>
</main>
